  ...
  const handleRemoveOwner = () => {
    handleAction(
      ...
      () => {
        ...
        if (quorum > totalAdmins - 1) return "Warning: Removing this admin will verify lock the contract (Quorum > Total). Update Quorum first!"
        return null
      },
      () => {
            ...
            <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2">
             ...
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="mt-4 flex items-start gap-2 text-xs text-amber-700 bg-amber-50 p-3 rounded border border-amber-100">
                    ...
                    <p>
                        <strong>Warning:</strong> Setting a low quorum reduces security. Setting it too high might lock the system if admins lose access.
                    </p>
                </div>
            </div>
        </div>
