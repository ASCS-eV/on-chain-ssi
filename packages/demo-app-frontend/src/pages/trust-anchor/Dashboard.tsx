            ...
            <div className="flex bg-white p-1 rounded-lg border border-slate-200">
                <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                        filter === 'needs_vote' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-500 hover:text-slate-700'
                    }`}
                >
                    Needs My Vote
                </button>
                <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                        filter === 'all' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-500 hover:text-slate-700'
                    }`}
                >
                    All Proposals
                </button>
