          ...
          <RevealOnScroll>
            <div className="space-y-8">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                A decentralized, on-chain governance framework for Verifiable Credentials. Establish
                trust, manage DIDs, and secure your company's digital sovereignty with the power of
                Etherlink.
              </p>
